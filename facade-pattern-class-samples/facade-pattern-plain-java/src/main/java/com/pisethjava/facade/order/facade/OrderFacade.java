...
public final class OrderFacade {
    ...
    public OrderFacade(CustomerService c,OrderValidator v,InventoryService i,PaymentService p,ShippingService s,InvoiceService n,NotificationService notify,AuditService a) {
        this.c=c;
        this.v=v;
        this.i=i;
        this.p=p;
